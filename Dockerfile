...
RUN wget https://ssd.mathworks.com/supportfiles/downloads/R2024b/Release/1/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_R2024b_Update_1_glnxa64.zip -P /tmp && \
    unzip -q /tmp/MATLAB_Runtime_R2024b_Update_1_glnxa64.zip -d /tmp/matlab_runtime_installer && \
    /tmp/matlab_runtime_installer/install -destinationFolder ${MATLAB_RUNTIME_INSTALL_DIR} -agreeToLicense yes -mode silent && \
    rm -rf /tmp/MATLAB_Runtime_R2024b_Update_1_glnxa64.zip /tmp/matlab_runtime_installer
